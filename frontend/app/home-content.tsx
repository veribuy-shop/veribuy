...
const verificationSteps = [
  {
    ...
    description: 'Enter details, select condition grade A/B/C, and set your price',
  },
  {
    emoji: '🔍',
    step: 'Step 2',
    title: 'IMEI Verified',
    description: 'Trust Lens checks IMEI against blacklist and stolen databases',
  },
  {
    emoji: '📸',
    step: 'Step 3',
    title: 'Evidence Stored',
    description: 'Photos and screenshots timestamped for dispute protection',
  },
  {
    emoji: '✅',
    step: 'Step 4',
    title: 'Go Live',
    description: 'Clean IMEI = instant approval. Flagged items get admin review',
  },
];
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-[var(--color-text-muted)] mt-2 text-sm md:text-base">
              Every listing is checked through our Trust Lens system
            </p>
          </div>
