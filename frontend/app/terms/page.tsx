...
export const metadata: Metadata = {
  ...
  description: 'VeriBuy Terms and Conditions - rules and policies for buying and selling verified electronics.',
  alternates: {
    canonical: '/terms',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-[var(--color-text-muted)]">
          ...
          <section>
            ...
            <p>
              By accessing and using VeriBuy, you accept and agree to be bound by these Terms and Conditions. 
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:admin@veribuy.shop" className="text-[var(--color-green)] hover:text-[var(--color-green-dark)] font-medium">
                admin@veribuy.shop
              </a>
            </p>
          </section>
