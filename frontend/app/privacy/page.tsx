        ...
        <div className="prose prose-lg max-w-none space-y-6 text-[var(--color-text-muted)]">
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              <a href="mailto:support@veribuy.shop" className="text-[var(--color-green)] hover:text-[var(--color-green-dark)] font-medium">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              You can delete them at any time via your browser settings, which will log you out. Read
              our <a href="/cookies" className="text-[var(--color-green)] hover:text-[var(--color-green-dark)] font-medium">Cookie Policy</a> for more information.
            </p>
          </section>
